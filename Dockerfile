...
FROM python:3.13.14-slim-trixie@sha256:9662417aace5ae7b8e2609cce472b72a8958e134ba372808abe9cc1a0c0125e6 AS builder
...
RUN python -m pip install --no-cache-dir --no-index --find-links=/wheels "rat-king==0.2.0" \
    && rm -rf /wheels
